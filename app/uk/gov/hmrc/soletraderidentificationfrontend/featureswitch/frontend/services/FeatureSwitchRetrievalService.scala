...
package uk.gov.hmrc.soletraderidentificationfrontend.featureswitch.frontend.services

import javax.inject.Inject
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.soletraderidentificationfrontend.featureswitch.core.models.FeatureSwitchSetting
import uk.gov.hmrc.soletraderidentificationfrontend.featureswitch.frontend.config.FeatureSwitchProviderConfig
import uk.gov.hmrc.soletraderidentificationfrontend.featureswitch.frontend.connectors.FeatureSwitchApiConnector
